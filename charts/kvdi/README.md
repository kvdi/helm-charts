...
you can find documentation in the [examples](https://github.com/kvdi/kvdi/blob/main/deploy/examples/example-vault-helm-values.yaml) folder.
There are examples for LDAP and OIDC authentication in the same folder.

For an up-to-date and complete list of all available options see the [API Reference](https://github.com/kvdi/kvdi/blob/main/doc/appv1.md#VDIClusterSpec).
...
the [example dashboard](https://github.com/kvdi/kvdi/blob/main/deploy/examples/example-grafana-dashboard.json) as a starting point in grafana.
